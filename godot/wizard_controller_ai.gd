...
class_name HecateWizardControllerAI extends HecateWizardController

# Perform a control step using AI.
func step(_animation : HecateWizardAnimation, _left_cast : HecateCast, _right_cast : HecateCast) -> void:
